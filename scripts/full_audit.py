...
legends = [
    ("Messi peak", "FW", dict(goals_pct_role=.99,xg_pct_role=.95,assists_pct_role=.90,
        ...
        pressures_pct_role=.35,tackles_pct_role=.20,goals_minus_xg_pct_role=.90,
        ball_recoveries_pct_role=.30,pressure_success_pct_role=.40),
        "Legendary", 93),
    ("Ronaldo peak", "FW", dict(goals_pct_role=.99,xg_pct_role=.90,shots_pct_role=.99,
        assists_pct_role=.55,dribbles_pct_role=.80,prog_carries_pct_role=.80,
        aerials_pct_role=.95,pressures_pct_role=.55,aerial_duel_success_pct_role=.90,
        key_passes_pct_role=.45,pass_completion_pct_role=.80,
        ball_recoveries_pct_role=.40,tackles_pct_role=.35),
        "Legendary", 90),
